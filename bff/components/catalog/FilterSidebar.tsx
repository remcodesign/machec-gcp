  ...
  return (
    ...
    >
      ...
      <form className="mt-5 space-y-5" action={path}>
        ...
        <fieldset>
          ...
          <div className="mt-2 grid grid-cols-2 gap-2">
            <input
              name="price_min"
              defaultValue={
                typeof filters.price_min === "string" ? filters.price_min : ""
              }
            ...
            <input
              name="price_max"
              defaultValue={
                typeof filters.price_max === "string" ? filters.price_max : ""
              }
              className="w-full border border-stone-300 bg-white px-3 py-2 text-sm"
              placeholder="Tot"
              inputMode="numeric"
        ...
        <button
          className="w-full cursor-pointer rounded-full bg-stone-950 px-4 py-2.5 text-sm font-medium text-white hover:bg-amber-700"
          type="submit"
        >
          Toon resultaten
        </button>
      ...
      <Link
        ...
        href={catalogHref(path, filters, { page: undefined })}
      >
